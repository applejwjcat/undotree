...
if !exists('g:undotree_debugenable')
    let g:undotree_debugenable = 0
endif
let s:debug = g:undotree_debugenable

if !exists('g:undotree_debugfile')
    let g:undotree_debugfile = $HOME.'/undotree_debug.log'
endif
let s:debugfile = g:undotree_debugfile
